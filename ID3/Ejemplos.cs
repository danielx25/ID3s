...
namespace ID3
{
    static class Ejemplos
    {
        ...
        public static Tabla tratamiento()
        {
        ...
        public static Tabla farmaco()
        {
            ...
            Columna edad = new Columna("edad", 14, true);   //otrasAlergias
            edad.addAtributo(new List<double> { 45 });
            edad[0] = 33;
            edad[1] = 44;
            edad[2] = 22;
            edad[3] = 12;
        ...
        public static Tabla transporte()
        {
        ...
        public static Tabla playballContinuo()
        {
            Columna outlook = new Columna("outlook", 14, false);
            outlook.addAtributo(new List<String> { "sunny", "overcast", "rain" });
            outlook[0] = "sunny";
            ...
            Columna humidity = new Columna("humidity", 14, true);
            humidity.addAtributo(new List<double> {75});
            humidity[0] = 85;
            humidity[1] = 90;
            humidity[2] = 78;
            humidity[3] = 96;
